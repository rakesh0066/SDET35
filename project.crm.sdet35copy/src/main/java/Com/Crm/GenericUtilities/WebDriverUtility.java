...
public class WebDriverUtility {
	...
	/**
	 * it will wait for is elements /asynchronous script to finish execution
	 * @parameter driver
	 */
	 ...
	 * @param title
	 */
	public void waitForTileContains(WebDriver driver,String title)
	{
		WebDriverWait wait = new WebDriverWait(driver, 10);
	 ...
	 * @param element
	 */
	public void waitForToElementToCustomer(WebDriver driver,int pollingTime,WebElement element)
	{
	...
	/**
	 * switch from one frame to another fame by using id_attribute
	 * @param driver
	 * @param id_attribute
	 */
	...
	/**
	 * switch from one frame to another frame by using absolte_path
	 * @param diver
	 * @param element
	 */
	...
	/**
	 * it is used to take ScreeShot /fileutils will create folder /file u should create folder
	 * @param driver
...
//	public <V> void waitForElementVisibility(WebDriver driver, WebElement ognHeaderTxt) {
//		WebDriverWait wait = new WebDriverWait(driver, 5);
//		wait.until((Function<? super WebDriver, V>) By.xpath("//span[@class='dvHeaderText']"));
